...
# login button
        loginbtn=Button(frame,command=self.register_window,text="LogIn",font=("times new romen",15,'bold'),bd=3,relief=RIDGE,fg='white',bg='grey',activeforeground='white',activebackground='grey')
...
# register button
    ...
    def forget_password(self):
        ...
        new_pass.place(x=20,y=85)
         
        #textEntry for password
        self.txtpass=ttk.Entry(frame_for,font=("times new romen",15,'bold'))
        self.txtpass.place(x=225,y=85,width=200)

        # label for password

        new_pass_check=lbl=Label(frame_for,text="Check Password",font=("times new romen",15,'bold'),fg="white",bg="black")
        new_pass_check.place(x=50,y=120)
         
        # textEntry for password

        self.txtcheck=ttk.Entry(frame_for,font=("times new romen",15,'bold'))
        self.txtcheck.place(x=255,y=120,width=200)
...
# address
        ...
        Address_entry=Entry(frame,textvariable=self.var_securityA,font=('times new roman',15,'bold'))
        Address_entry.place(x=400,y=250,width=250)
# adhar no

        adhar=Label(frame,text="Adhar Number",font=('times new roman',15,'bold'),bg="white")
        adhar.place(x=50,y=280)

        adhar_entry=Entry(frame,textvariable=self.var_password,font=('times new roman',15,'bold'))
        adhar_entry.place(x=50,y=310,width=250)
...
# city
        ...
        City_entry=Entry(frame,textvariable=self.var_confirmpassword,font=('times new roman',15,'bold'))
